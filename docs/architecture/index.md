...
| [ADR-017](adr/017-opinionless-tool-instructions.md) | Accepted | The engine ships input-shape and channel mechanics for tool instructions; style, depth, and workflow framing are consumer-owned. |
