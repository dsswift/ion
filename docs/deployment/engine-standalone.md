...
The Ion Engine is a single static Go binary. `CGO_ENABLED=0`, zero runtime dependencies, no glibc requirement. It runs on any Linux or macOS host without installation beyond copying the binary.
