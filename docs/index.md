...
Ion is a headless AI agent runtime. Single Go binary, zero runtime dependencies. It runs as a daemon on a Unix socket or TCP port, speaks NDJSON, and executes LLM-driven agent loops with tool use, branching conversations, and a hook-based extension system.
