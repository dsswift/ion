...
export interface PreferencesState {
  ...
  /** Whether Ion Studio shows its conversation Tab Strip. */
  studioTabStripVisible: boolean
  setStudioTabStripVisible: (visible: boolean) => void
