...
export interface ValidatedPack {
  ...
  characters: Map<string, PackEntry<StudioCharacterManifest>>
  pets: Map<string, PackEntry<StudioPetManifest>>
  furniture: Map<string, PackEntry<StudioFurnitureManifest>>
  floors: Map<string, PackEntry<StudioFloorManifest>>
  walls: Map<string, PackEntry<StudioWallManifest>>
  bubbles: { packId: string; manifest: StudioBubblesManifest } | null
  dressing: Map<string, { packId: string; template: StudioDressingTemplate }>
}
