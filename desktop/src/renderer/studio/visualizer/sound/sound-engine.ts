/**
 * sound-engine — the Studio window's ambient soundscape, fully procedural (WebAudio
 ...
 * (Chromium autoplay policy); the studioSound setting persists the toggle.
 */
...
export class StudioSoundEngine {
