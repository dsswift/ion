/**
 * OfficeState — the imperative simulation heart of Studio. Lives outside React
...
export class OfficeState {
  ...
  syncRoster(roster: Roster): void {
    const seen: Array<{ name: string; displayName: string; role: StudioRole; color: string; characterId: string | null }> = []
