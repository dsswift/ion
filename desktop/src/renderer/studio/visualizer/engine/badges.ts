...
export const BADGE_COLORS: Record<BadgeKind, string> = {
  terminal: '#1f2937', // hardcoded-ok: Studio canvas palette is theme-pack-driven, not app-theme-driven
  search: '#1e3a5f', // hardcoded-ok: Studio canvas palette is theme-pack-driven, not app-theme-driven
  edit: '#3b2f1e', // hardcoded-ok: Studio canvas palette is theme-pack-driven, not app-theme-driven
  web: '#1e3a2f', // hardcoded-ok: Studio canvas palette is theme-pack-driven, not app-theme-driven
  task: '#3a1e3a', // hardcoded-ok: Studio canvas palette is theme-pack-driven, not app-theme-driven
  generic: '#2a2a2e', // hardcoded-ok: Studio canvas palette is theme-pack-driven, not app-theme-driven
}
