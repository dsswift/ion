/**
 * ReplayBar — transport controls for session replay: scrub, play/pause,
 * speed cycle, and a prominent LIVE return. Mounted by VisualizerRoot when the user
...
export function ReplayBar(props: ReplayBarProps): React.JSX.Element | null {
