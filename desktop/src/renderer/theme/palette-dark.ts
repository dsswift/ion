...
export const darkColors = {
  ...
  containerShadow:
    "0 8px 28px rgba(0, 0, 0, 0.5), 0 1px 6px rgba(0, 0, 0, 0.35)",
  ...
  graphNodeDefault: "#a4abbb",
  graphNodeAnchor: "#c9a0dc",
  graphNodeDangling: "#5a5a63",
  graphNodeGroup: "#c98a5a",
  graphNodeSection: "#6bb89e",
  graphEdgeDefault: "#363941",
  graphEdgeMediated: "#2b2d34",
  graphEdgeDangling: "#232529",
  graphUnknown: "#5a5a63",
  graphSupersession: "#e0a458",
  graphLabel: "#d3d7df",
  graphLabelHalo: "rgba(19, 19, 22, 0.85)",
  graphLabelHub: "#f2f4f8",
  graphLabelPlate: "rgba(19, 19, 22, 0.72)",
  graphNodeOutline: "rgba(10, 10, 14, 0.55)",
  graphStageVignette: "rgba(0, 0, 0, 0.5)",
  graphCategorical1: "#6f9bf0",
  graphCategorical2: "#e8b04a",
  graphCategorical3: "#5fc48f",
  graphCategorical4: "#e07a7a",
  graphCategorical5: "#b48cf2",
  graphCategorical6: "#4fc6d4",
  graphCategorical7: "#f08fc0",
  graphCategorical8: "#8fa3b5",
  graphCategorical9: "#e59a5c",
