...
export const lightColors: ColorPalette = {
  ...
  graphNodeDefault: "#6b7385",
  graphNodeAnchor: "#8e5fb0",
  graphNodeDangling: "#9a9aa0",
  graphNodeGroup: "#a8632f",
  graphNodeSection: "#2f7d64",
  graphEdgeDefault: "#cdd1d9",
  graphEdgeMediated: "#dcdfe5",
  graphEdgeDangling: "#e7e9ee",
  graphUnknown: "#9a9aa0",
  graphSupersession: "#b3701f",
  graphLabel: "#3a3a42",
  graphLabelHalo: "rgba(251, 251, 252, 0.88)",
  graphLabelHub: "#1c1c22",
  graphLabelPlate: "rgba(251, 251, 252, 0.82)",
  graphNodeOutline: "rgba(255, 255, 255, 0.85)",
  graphStageVignette: "rgba(20, 24, 40, 0.07)",
  graphCategorical1: "#3564d0",
  graphCategorical2: "#b8791a",
  graphCategorical3: "#2f8f5c",
  graphCategorical4: "#c44d4d",
  graphCategorical5: "#7a4fcf",
  graphCategorical6: "#1f8f9c",
  graphCategorical7: "#c2508f",
  graphCategorical8: "#5f7086",
  graphCategorical9: "#c26a2a",
