...
export const hudColors: ColorPalette = {
  ...
  graphNodeDefault: "#6fb3cf",
  graphNodeAnchor: "#c98cf7",
  graphNodeDangling: "#3d5570",
  graphNodeGroup: "#f7a833",
  graphNodeSection: "#33f7c3",
  graphEdgeDefault: "#173c55",
  graphEdgeMediated: "#122f43",
  graphEdgeDangling: "#0e2536",
  graphUnknown: "#3d5570",
  graphSupersession: "#f7d433",
  graphLabel: "rgba(170, 225, 250, 0.92)",
  graphLabelHalo: "rgba(4, 12, 26, 0.88)",
  graphLabelHub: "#e8f7ff",
  graphLabelPlate: "rgba(4, 12, 26, 0.75)",
  graphNodeOutline: "rgba(2, 8, 20, 0.6)",
  graphStageVignette: "rgba(0, 4, 12, 0.55)",
  graphCategorical1: "#33c3f7",
  graphCategorical2: "#f7c433",
  graphCategorical3: "#4ff0a0",
  graphCategorical4: "#ff7a7a",
  graphCategorical5: "#b78bff",
  graphCategorical6: "#33f7e0",
  graphCategorical7: "#ff8ad4",
  graphCategorical8: "#8aa4c2",
  graphCategorical9: "#ffa04d",
