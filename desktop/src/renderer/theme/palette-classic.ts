...
export const classicColors: ColorPalette = {
  ...
  statusAsync: "#d946ef",
  statusAsyncGlow: "rgba(217, 70, 239, 0.4)",
  ...
  timelinePlanImplementation: "#7AAC8C",
  timelinePlanImplementationActive: "#9BC7A8",
  ...
  // Graph View (WebGL node-link renderer, GH #397)
  graphNodeDefault: "#b3a68e",
  graphNodeAnchor: "#b08cc4",
  graphNodeDangling: "#6b665e",
  graphNodeGroup: "#8a9a5a",
  graphNodeSection: "#6bb8a0",
  graphEdgeDefault: "#46443b",
  graphEdgeMediated: "#3a3831",
  graphEdgeDangling: "#31302a",
  graphUnknown: "#6b665e",
  graphSupersession: "#e0a458",
  graphLabel: "#c6c2b6",
  graphLabelHalo: "rgba(36, 36, 34, 0.85)",
  graphLabelHub: "#e6e1d4",
  graphLabelPlate: "rgba(36, 36, 34, 0.72)",
  graphNodeOutline: "rgba(20, 20, 18, 0.55)",
  graphStageVignette: "rgba(0, 0, 0, 0.45)",
  graphCategorical1: "#7a9cd6",
  graphCategorical2: "#d9a94c",
  graphCategorical3: "#7fb58a",
  graphCategorical4: "#d17b6a",
  graphCategorical5: "#ad8fd0",
  graphCategorical6: "#63b5b8",
  graphCategorical7: "#d68fb0",
  graphCategorical8: "#a09a8c",
  graphCategorical9: "#d0895a",
