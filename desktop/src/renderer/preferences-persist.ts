...
export function loadPersistedSettings(
  ...
  applyTheme: (themeIdOrDark: string | boolean) => void,
): void {
  window.ion?.loadSettings().then((disk) => {
    ...
    applyTheme(getTheme(selectedTheme).forcedColorScheme ? selectedTheme : resolved)
