...
export function loadPersistedSettings(
  ...
  return Promise.resolve(window.ion?.loadSettings()).then((disk) => {
    ...
    const projects = shouldMigrateProjectSettings
      ...
      : sanitizeProjectRegistry(disk.projects)
