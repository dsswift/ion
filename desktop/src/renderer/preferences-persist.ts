...
export function loadPersistedSettings(
  ...
  window.ion?.loadSettings().then((disk) => {
    ...
    const integrationOpen = typeof disk.gitPanelIntegrationOpen === 'boolean' ? disk.gitPanelIntegrationOpen : true
