...
export function TabsPanelsCategory() {
  ...
  return (
    <>
      ...
      <SettingHeading>Conversation Recovery</SettingHeading>

      <SettingToggle
        label="Automatic Conversation Recovery"
        description="Automatically resume interrupted conversations after the engine restarts. Slow or silent live runs are never replayed or cancelled."
