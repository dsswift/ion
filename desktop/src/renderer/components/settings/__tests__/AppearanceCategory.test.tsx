...
vi.mock('../../../preferences', () => ({
  usePreferencesStore: (selector: (state: Record<string, unknown>) => unknown) => selector({
    ...
    editorFontSize: 14, setEditorFontSize: vi.fn(), conversationFontSize: 14, setConversationFontSize: vi.fn(),
    previewFontSize: 14, setPreviewFontSize: vi.fn(), closeExplorerOnFileOpen: false, setCloseExplorerOnFileOpen: vi.fn(),
