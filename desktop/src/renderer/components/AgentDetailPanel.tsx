...
/**
 * The overlay's floating dispatch-preview host: FloatingPanel chrome +
 * persisted geometry around the shared AgentDetailBody (which the Studio
 * DispatchSplitPane also renders — one implementation, two hosts).
 */
