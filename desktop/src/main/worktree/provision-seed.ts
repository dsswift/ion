/**
 * Seeding one declared directory into a new worktree.
 *
 * ── The ladder ──────────────────────────────────────────────────────────────
 ...
 *
 * **Sharing is permanently absent from that list.** A symlinked `node_modules`
 ...
 */
import { constants, cpSync, existsSync, readFileSync, statSync } from 'fs'
...
export type SeedStrategy = 'clone' | 'build' | 'copy' | 'skipped' | 'failed'
