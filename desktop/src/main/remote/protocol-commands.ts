...
export type RemoteCommand =
  ...
  | { type: 'desktop_prompt'; tabId: string; text: string; origin?: 'desktop' | 'remote'; clientMsgId?: string; attachments?: Array<{ type: 'image' | 'file'; name: string; path: string; contentHash?: string }>; implementationPhase?: boolean; instanceId?: string }
  ...
  | { type: 'desktop_tab_reorder_pin'; assignments: Array<{ tabId: string; orderKey: string }> }
