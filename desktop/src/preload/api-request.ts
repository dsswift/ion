...
export const requestApi = {
  ...
  resolveNewConversationDefaults: (path: string) =>
    ipcRenderer.invoke(IPC.RESOLVE_NEW_CONVERSATION_DEFAULTS, path),
  ...
  onTerminalActivity: (callback) => {
    const handler = (
      ...
      activity: import("../shared/terminal-activity").TerminalActivity,
    ) => callback(activity);
