 ...
 * Studio cache and renderer stores so every surface clears queues on the same
 ...
 * (event-slice) and the Studio window canvas bubble clear (mapping.ts): a run that is
