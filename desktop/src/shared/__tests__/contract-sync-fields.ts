...
export const TS_NORMALIZED_EVENTS: Record<string, string[]> = {
  ...
  background_task_started: ["command", "notifyOnComplete", "startedAt", "taskId"],
  background_task_terminal: ["command", "elapsedMs", "exitCode", "outputPath", "status", "tail", "taskId"],
  session_work_stopped: ["cancelledRunId", "killedAgentProcessCount", "recalledDispatchIds", "scope", "stoppedBackgroundTaskIds"],
...
export const TS_SHARED_TYPES: Record<string, string[]> = {
  ...
  BackgroundTaskState: ["command", "notifyOnComplete", "startedAt", "taskId", "toolId"],
  EngineConfig: [
    "claudeCompat",
