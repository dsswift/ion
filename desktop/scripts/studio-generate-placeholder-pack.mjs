#!/usr/bin/env node
/**
 * One-shot generator for the Studio visualizer placeholder theme pack.
 *
 * Emits flat-shaded placeholder PNGs plus fully valid manifests to
 * desktop/resources/studio/themes/ion-works/ in the exact Pass-1 MVP-kit shape,
 ...
 *
 * Run manually (output is committed): node scripts/studio-generate-placeholder-pack.mjs
...
const ROOT = join(dirname(fileURLToPath(import.meta.url)), '..', 'resources', 'studio', 'themes', 'ion-works')
const TILE = 16

// Master palette (docs/design/visualizer/asset-design.md)
const PALETTE = [
