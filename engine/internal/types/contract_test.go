...
func normalizedEventVariants() map[string]NormalizedEventData {
	return map[string]NormalizedEventData{
		...
		EventBackgroundTaskStarted:   &BackgroundTaskStartedEvent{},
		EventBackgroundTaskTerminal:  &BackgroundTaskTerminalEvent{},
...
func buildManifest() contractManifest {
	...
	shared := map[string]reflect.Type{
		...
		"BackgroundTaskState": reflect.TypeOf(BackgroundTaskState{}),
