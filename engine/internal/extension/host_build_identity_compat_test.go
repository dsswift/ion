...
func TestParseInitResult_BuildIdentityMismatchLoadsTools(t *testing.T) {
	...
	raw := []byte(`{"buildIdentity":"v1.0.0","tools":[{"name":"older_sdk_tool","description":"d","parameters":{"type":"object"}}]}`)
...
func TestParseInitResult_NewerSDKIdentityLoadsTools(t *testing.T) {
	...
	raw := []byte(`{"buildIdentity":"v3.0.0","tools":[{"name":"newer_sdk_tool","description":"d","parameters":{"type":"object"}}]}`)
	if err := h.parseInitResult(raw); err != nil {
